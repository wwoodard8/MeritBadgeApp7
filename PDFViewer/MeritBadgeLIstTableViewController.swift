...
class MeritBadgeLIstTableViewController: UITableViewController {
    ...
    func createArray () -> [MeritBadge] {
        ...
        ["painting", "Painting"],
        ["personalfitness", "Personal Fitness"],
        ...
        ["reading", "Reading"],
        ["reptileandamphibianstudy", "Reptile and Amphibian Study"],
        ...
        ["scoutingheritage", "Scouting Heritage"],
        ["scubadiving", "Scuba Diving"],
        ["sculpture", "Sculpture"],
        ["searchandrescue", "Search and Rescue"],
        ["shotgunshooting", "Shotgun Shooting"],
        ["signssignalscodes", "Signals Signs and Codes"],
        ["skating", "Skating"],
        ["smallboatsailing", "Small Boat Sailing"],
        ["snowsports", "Snow Sports"],
        ["soilandwaterconservation", "Soil and Water Conservation"],
